...
import { LineChart, Line, Label, CartesianGrid, XAxis, YAxis, Tooltip, ResponsiveContainer } from 'recharts';
...
class Forecasting extends React.Component {
    ...
    render() {
        return <div>
            <MainLayout isDirector={this.state.isDirector} pageName={this.state.pageName}>
                    ...
                    <div className="row h-100 w-75">
                        ...
                        <ResponsiveContainer>
                            <LineChart data={this.state.monthlyData}>
                                ...
                                <YAxis dataKey="c02" >
                                    <Label value="C02 Emissions (Kg)" angle={270}  offset={-5} position="left" />
                                </YAxis>
                                <Tooltip />
                            </LineChart>
                            </ResponsiveContainer>
