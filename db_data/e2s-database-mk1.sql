...
INSERT INTO `buisness_goals` (`goal_id`, `goal_desc`) VALUES
	(1, 'I would like to save energy to make the world a better place'),
	(2, 'I would like to save money for my site so we have more money to spend'),
	(3, 'I would like to analyse the amount of energy my site uses compared to other similar companies'),
	(4, 'I would like to recieve unique insights into how I can save my site money');
...
INSERT INTO `energy_asset_data` (`asset_id`, `type_id`, `room_id`, `energy_usage`, `energy_output`, `pre_cost`, `pre_emission`) VALUES
	(1, 1, 1, 20, 0, 25, 3),
	(2, 7, 2, 80, 0, 55, 12),
	(3, 2, 2, 5, 0, 5, 1);
...
INSERT INTO `rooms` (`room_id`, `site_id`, `room_size_x`, `room_size_y`, `room_pos_x`, `room_pos_y`) VALUES
	(1, 3, 10, 10, 25, 30),
	(2, 3, 5, 5, 45, 45),
	(3, 1, 2, 3, 5, 5),
	(4, 2, 10, 2, 20, 26);
...
-- Dumping data for table e2s_db.site_data: ~3 rows (approximately)
/*!40000 ALTER TABLE `site_data` DISABLE KEYS */;
INSERT INTO `site_data` (`site_id`, `post_code`, `address_l1`, `address_l2`, `county`, `site_size_x`, `site_size_y`) VALUES
	(1, 'ST21 C45', '21 Fictional Way', 'Building 5', 'Worcestershire', 20, 50),
	(2, 'EE4 A83', '15 Made This Up Place', '0', 'Devon', 234, 43),
	(3, 'AA93 Y56', '99 Road Street', 'ADR2', 'Scotland', 80, 80);
...
CREATE TABLE IF NOT EXISTS `site_data_organisations_crossref` (
  ...
  CONSTRAINT `FK_site_data_organisations_crossref_site_data` FOREIGN KEY (`site_id`) REFERENCES `site_data` (`site_id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table e2s_db.site_data_organisations_crossref: ~0 rows (approximately)
...
-- Dumping data for table e2s_db.user_data_site_data_crossref: ~1 rows (approximately)
